...
namespace WarCroft.Core
{
    public class WarController
    {
        ...
        public string GetStats()
        {
            ...
            var characters = characterParty.OrderByDescending(x => x.IsAlive).ThenByDescending(x => x.Health);
        ...
        {
            var attacker = characterParty.FirstOrDefault(x => x.Name == args[0]);
            var receiver = characterParty.FirstOrDefault(x => x.Name == args[1]);
            ...
            string output = string.Format(SuccessMessages.AttackCharacter,
                warrior.Name, receiver.Name, warrior.AbilityPoints, receiver.Name, receiver.Health, receiver.BaseHealth, 
        ...
        {
            var healer = characterParty.FirstOrDefault(x => x.Name == args[0]);
            var receiver = characterParty.FirstOrDefault(x => x.Name == args[1]);
