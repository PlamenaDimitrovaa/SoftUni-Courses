...
namespace TaskBoardApp.Data.Migrations
{
    ...
    [Migration("20230425185041_Initial")]
            ...
            modelBuilder.Entity("TaskBoardApp.Data.Entities.Task", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BoardId = 1,
                            CreatedOn = new DateTime(2023, 3, 25, 21, 50, 40, 697, DateTimeKind.Local).AddTicks(158),
                            Description = "Learn using ASP .NET Core Identity",
                            OwnerId = "813393db-3915-4aab-bdca-99641ef4ae20",
                        ...
                        new
                        {
                            Id = 2,
                            BoardId = 3,
                            CreatedOn = new DateTime(2022, 11, 25, 21, 50, 40, 697, DateTimeKind.Local).AddTicks(192),
                        ...
                        new
                        {
                            Id = 3,
                            BoardId = 2,
                            CreatedOn = new DateTime(2023, 4, 15, 21, 50, 40, 697, DateTimeKind.Local).AddTicks(196),
                            Description = "Learn using ASP.NET Core Identity",
                            OwnerId = "813393db-3915-4aab-bdca-99641ef4ae20",
                        ...
                        new
                        {
                            Id = 4,
                            BoardId = 3,
                            CreatedOn = new DateTime(2022, 4, 25, 21, 50, 40, 697, DateTimeKind.Local).AddTicks(198),
            ...
            modelBuilder.Entity("TaskBoardApp.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "813393db-3915-4aab-bdca-99641ef4ae20",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "0a08074f-3345-4e1e-8275-8460f6ba2388",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEB+B699cEmLWPqQXIf/WQbiFNS3aIH1wJfuKJLdnsby+2ielPNVEghFuTzWyzo7bvw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "6118649f-f305-4967-9a03-02151676c43a",
